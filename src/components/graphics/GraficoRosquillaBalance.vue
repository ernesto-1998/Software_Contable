<template>
  <div class="row justify-center">
    ...
    <div class="col-md-auto bg-grey-2">
      <canvas id="activo1" width="150" height="200"></canvas>
    </div>
    <div class="col-md-auto bg-grey-2">
  ...
  <div class="row justify-center q-mt-xl">
    ...
    <div class="col-md-auto bg-grey-2">
      <canvas id="activo2" width="150" height="200"></canvas>
    </div>
    <div class="col-md-auto bg-grey-2">
...
const totalesBalanceAño1 = obtenerTotalesBalance(props.periodos[0]);
const totalesBalanceAño2 = obtenerTotalesBalance(props.periodos[1]);
let graphic1 = null;
let graphic2 = null;
let graphic3 = null;
let graphic4 = null;
...
const activoAño1 = totalesBalanceAño1.totalActivo;
const pasivoAño1 = totalesBalanceAño1.totalPasivo;
const patrimonioAño1 = totalesBalanceAño1.totalPatrimonio;
const totalAño1 = activoAño1 + pasivoAño1 + patrimonioAño1;
